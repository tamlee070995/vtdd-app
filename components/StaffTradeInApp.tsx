...
@media (max-width: 640px) {
  ...
  .staff-command .staff-hero-actions .vtdd-guide-link {
    display: inline-flex !important;
    position: absolute !important;
    top: 17px !important;
    left: 48% !important;
  ...
  .staff-command .staff-hero-actions .vtdd-guide-link::before {
  ...
  .staff-os-shell > .vtdd-system-marquee {
    min-height: 56px !important;
    padding: 10px 12px !important;
    overflow: hidden !important;
  }

  .staff-os-shell > .vtdd-system-marquee span {
    position: absolute !important;
    top: 50% !important;
    left: 100% !important;
    ...
    animation: vtddMarqueeVisible 16s linear infinite !important;
    font-size: 12px !important;
    line-height: 1 !important;
...
function ProfilePasswordEyeIcon({ hidden }: { hidden: boolean }) {
  return hidden ? (
...
function ProfilePasswordInput({
  ...
  return (
    <div className="profile-v3-password-field" data-visible={visible ? "1" : "0"}>
      ...
      >
        <ProfilePasswordEyeIcon hidden={visible} />
      </button>
    </div>
  );
}
